...
public class MysqlAppTest {
  ...
  public void json() {
    ...
    Assertions.assertThat(r.getBody())
        .isEqualTo(
            "{\"a1\":\"10\",\"bb\":\"扯淡扯扯淡\",\"c1\":\"123456789012567890123458901256789012346789012345890123467890123456789012567890123458901256789012346789012345890123467890\",\"b1\":\"毛主席在天安门城楼上宣布中华人民共和国中央人民政府今天成立了\"}");
